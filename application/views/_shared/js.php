...
<!-- jspdf -->
<script src="<?php echo base_url(); ?>assets/js/jspdf/jspdf.debug.js"></script>
<script src="<?php echo base_url(); ?>assets/js/jspdf/split_text_to_size.js"></script>
<script src="<?php echo base_url(); ?>assets/js/jspdf/jspdf.plugin.autotable.js"></script>
<script src="<?php echo base_url(); ?>assets/js/jspdf/jspdf_center_plugin.js"></script>
<script src="<?php echo base_url(); ?>assets/js/jspdf/total_pages.js"></script>
<script src="<?php echo base_url(); ?>assets/js/jspdf/autoprint.js"></script>
